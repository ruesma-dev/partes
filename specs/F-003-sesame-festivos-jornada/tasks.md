...
- [x] T1: `jornada_efectiva` en sv4 (`application/services/jornada_resolver.py`)
...
- [x] T2: inaugurar `services/partes-persistencia/tests/` (conftest.py,
...
- [x] T3: `SesameApiClient` de sv4 (`infrastructure/sesame/`) con
...
- [x] T4: `CalendarioProvider` de sv4: caché TTL (DNI × año),
...
- [x] T5: settings sv4 (`SESAME_*` + `sesame_enabled`), wiring en
...
- [x] T6: vistas sv4 — festivos por trabajador en `trabajador_detail`
...
- [x] T10: aviso festivo/domingo en el preflight de aprobación (líneas
      con horas > 0). | Verificación: `test_f003_r18_*`
- [x] T11: `SesameApiClient` de sv3 (gemelo de T3) +
...
- [x] T12: wiring sv3 (settings `SESAME_*`, `interface_adapters/api/app.py`
...
- [x] T13: infra — `SESAME_API_BASE_URL` (redactada) y `SESAME_API_KEY`
...
- [x] T14: actualizar `azure-apps/partes.md` (consumo de sesame-api:
...
- [x] T15: nivel 2 en sv4 (D2 corregida) — `aprobar_preflight` anexa
...
- [x] T16: señal de revisión en sv3 (R26) — `document_id` en
      ...
      `test_f003_r27_*`)
- [x] T17: CLAUDE.md del repo (D1 aprobada) — en la regla LÍMITE DE
