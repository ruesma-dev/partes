...
Generado por `python -m harness.mutacion --feature F-003` el 2026-08-15 22:27.
...
### 12. `services/partes-front/interface_adapters/web/app.py:546` [logico]
...
### 13. `services/partes-front/interface_adapters/web/app.py:1085` [booleano]
...
### 14. `services/partes-front/interface_adapters/web/app.py:1501` [comparacion]
...
### 15. `services/partes-front/interface_adapters/web/app.py:1603` [logico]
...
### 16. `services/partes-front/interface_adapters/web/app.py:1607` [logico]
...
### 17. `services/partes-persistencia/application/services/jornada_resolver.py:25` [logico]
...
### 18. `services/partes-persistencia/application/services/recurso_conciliador.py:419` [entero]
...
### 19. `services/partes-persistencia/config/settings.py:125` [entero]
...
### 20. `services/partes-persistencia/infrastructure/calendario/sesame_calendario_laboral.py:60` [entero]
...
### 21. `services/partes-persistencia/infrastructure/calendario/sesame_calendario_laboral.py:167` [logico]
...
### 22. `services/partes-persistencia/infrastructure/calendario/sesame_calendario_laboral.py:175` [logico]
...
### 23. `services/partes-persistencia/infrastructure/calendario/sesame_calendario_laboral.py:194` [logico]
...
### 24. `services/partes-persistencia/infrastructure/calendario/sesame_calendario_laboral.py:200` [logico]
...
### 25. `services/partes-persistencia/infrastructure/calendario/sesame_calendario_laboral.py:205` [comparacion]
...
### 26. `services/partes-persistencia/infrastructure/sesame/sesame_api_client.py:50` [entero]
...
### 27. `services/partes-persistencia/infrastructure/sesame/sesame_api_client.py:60` [booleano]
...
### 28. `services/partes-persistencia/interface_adapters/api/app.py:77` [logico]
