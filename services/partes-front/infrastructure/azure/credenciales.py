...
"""Credencial de Azure para cola/blob en el portal (sv4).

En Container Apps usa la managed identity asignada (AZURE_CLIENT_ID); en
local cae a la cadena por defecto (az login, variables, etc.). Nada de
connection strings ni claves en runtime.
"""
